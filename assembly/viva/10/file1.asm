;X86/64 Assembly language program (ALP) to find
...
;Write FAR PROCEDURES in Program_2 for the rest of the processing.;Use of PUBLIC/GLOBAL and EXTERN directives is mandatory
; extern is used to import specific procedure or variable global  filehandle, char, buf, abuf_len;global can be imported by other programs
;%include includes the whole asm file
%include "file2.asm"
...
section .text
    global _start      
_start:
        print   ano,ano_len     ;program title

        print   filemsg,filemsg_len     
        read    filename,50;actual length of characters read in stored in rax including EOF 
        dec rax
